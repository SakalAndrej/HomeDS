...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{images\06_AndroidApp\03_SystemArch}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{images\06_AndroidApp\03_XiboApi}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{images\06_AndroidApp\03_EditApplikation}
\caption{Grundeinstellungen einer XIBO-Anwendnug}
\label{fig:mediaNav}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{images\06_AndroidApp\03_ApplikationPermission}
