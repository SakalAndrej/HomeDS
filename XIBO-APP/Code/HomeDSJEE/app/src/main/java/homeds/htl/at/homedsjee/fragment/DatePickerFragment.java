...
public class DatePickerFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btSaveTime = v.findViewById(R.id.btSaveTime);
        ...
        btSaveTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePicker datePicker = view.findViewById(R.id.dpDataset);

                Bundle bundle = new Bundle();
                bundle.putSerializable("date",(new Date(datePicker.getYear(),datePicker.getMonth(),datePicker.getDayOfMonth())).toInstant().atZone(ZoneId.systemDefault()).toInstant().toString());
